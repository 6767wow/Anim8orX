...
- Optimized retained GDI viewport shell with cached pens/brushes, persistent back buffer, cached projection basis, per-frame mesh vertex projection, and no idle repaint timer.
